...
export const TwoColumnBlock = {
    ...
    renderHTML(block, context = {}) {
        return `
            <div x-show="block.type === 'twoColumn'" 
                 ...
                 :style="block.style || ''"
                 :class="['grid grid-cols-2 gap-4 p-4 border-2 border-dashed border-gray-300 rounded-lg min-h-[200px]', block.classes || '']">
    ...
    renderChildHTML(child, context = {}) {
        return `
            <div x-show="child.type === 'twoColumn'" 
                 :id="child.htmlId || null"
                 :style="child.style || ''"
                 :class="['grid grid-cols-2 gap-2 p-2 border border-dashed border-gray-300 rounded min-h-[150px]', child.classes || '']">
